  ...
  <div id="page-head">
    ...
    <div class="text-right breadcrumb">
      ...
      <form action="<?php echo site_url('data_pelanggaran_kerapian/cari') ?>" method="post" class="col-xs-8 col-sm-3 text-right">
...
<div class="tab-base">
                        <ul class="nav nav-tabs tabs-right">
                            ...
                            <li>
                                <a  href="data_pelanggaran_berat">pelanggaran_Berat</a>
                            </li>
                        </ul>
          ...
          <div class="panel panel-purple panel-colorful">
            <div class="pad-all text-left">
              ...
              <div class="btn-group btn-group-justified pad-top">
               ...
               <span>
                <a data-toggle="modal" data-target="#demo-default-modal1<?php echo $res->id_pelanggaran_kerapian?>" class=" btn btn-warning btn-sm">
                  <span class="fa fa-edit"></span>
                  &nbsp;Edit
                </a>
              </span>
              <span>
               <a data-toggle="modal" data-target="#demo-default-modal2<?php echo $res->id_pelanggaran_kerapian?>" class=" btn btn-danger btn-sm">
    ...
    <div class="modal fade" id="demo-default-modal1<?php echo $res->id_pelanggaran_kerapian?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <?= form_open_multipart('data_pelanggaran_kerapian/edit'); ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-danger" href="<?php echo base_url('data_pelanggaran_kerapian/hapus/'. $res->id_pelanggaran_kerapian) ?>">Hapus pelanggaran_kerapian</a>
          </div>
        </div>
      </div>
    </div>
