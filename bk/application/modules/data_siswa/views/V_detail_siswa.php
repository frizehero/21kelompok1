        ...
        <div class="nano">
          <div class="nano-content">
            <p class="pad-all text-main text-sm text-uppercase text-bold">
              Pelanggaran Terbaru <br><br> <?php foreach($tampil as $res) {?> <?php echo $res->nama_siswa?> <?php } ?>
            </p>
            <hr>
            ...
            <div class="list-group bg-trans bord-btm">
              ...
              <?php foreach ($tampil_pelanggaran as $tment) {
               ...
               <div class="list-group-item">
                 <?php echo $tment->nama_pelanggaran ?>
               </div>
               <?php if($A++ == 5) break; ?>
             <?php } ?> 
             ...
             <?php foreach ($tampil_pelanggaran_kerapian as $tment) {
               $id = $tment->id_riwayat_pelanggaran;?>
               <div class="list-group-item">
                <?php echo $tment->nama_pelanggaran_kerapian ?>
              </div>
              <?php if($B++ == 5) break; ?>
            <?php } ?>
            ...
            <?php foreach ($tampil_pelanggaran_berat as $tment) {
             $id = $tment->id_riwayat_pelanggaran;?>
             <div class="list-group-item">
              <?php echo $tment->nama_pelanggaran_berat ?>
            </div>
            <?php if($C++ == 5) break; ?>
          <?php } ?>
