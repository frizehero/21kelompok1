  ...
  <div id="page-head">
  	...
  	<div class="text-right breadcrumb">
        ...
        <a class="btn btn-default text-left form-control" style="padding-left: : 10px" href="<?php echo base_url('data_kelas_guru'); ?>">Kembali</a>
      </div>
            ...
            <ul class="list-unstyled text-center bord-top pad-top mar-no row">
              <li class="col-xs-5">
                <span class="text-muted mar-no">
                  ...
                  $jumlah_pelanggaranku      = $this->m_data_kelas_guru->count_jpelanggaran($id);
                  $jumlah_pelanggaran_kerapian  = $this->m_data_kelas_guru->count_jpelanggaran_kerapian($id);
                  $jumlah_pelanggaran_berat   = $this->m_data_kelas_guru->count_jpelanggaran_berat($id);
              ...
              <li class="col-xs-4">
                <span class="text-muted mar-no">
                  ...
                  $jumlah_treatment    = $this->m_data_kelas_guru->count_jtreatment($id);
              ...
              <li class="col-xs-3">
                <span class="text-muted mar-no">
                  <?php 
                  $jpelanggaran1          = $this->m_data_kelas_guru->jumlahpelanggaran1($id);
                  $jpelanggaran2          = $this->m_data_kelas_guru->jumlahpelanggaran2($id);
                  $jpelanggaran3          = $this->m_data_kelas_guru->jumlahpelanggaran3($id);
                  $jumlahpointtreatment   = $this->m_data_kelas_guru->jumlahpointtreatment($id);
