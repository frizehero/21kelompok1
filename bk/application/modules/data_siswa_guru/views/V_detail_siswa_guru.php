              ...
              <?php foreach ($terbaru as $terbaru) {
                ...
                <div class="list-group-item">
                  <div class="media-left pos-rel">
                    <a href="<?php echo base_url('data_siswa_guru/details/'.$terbaru->id_siswa) ?>"><img class="img-circle img-xs" src="<?php echo base_url ()?>assets/img/<?php echo $terbaru->foto_siswa ?>" alt="Profile Picture"></a>
                  </div>
                  <div class="media-body">
                    <a href="<?php echo base_url('data_siswa_guru/details/'.$terbaru->id_siswa) ?>" class="text-main">
                      <p><?php echo $terbaru->nama_siswa ?></p>
                    </a>
                    <a class="btn btn-xs btn-default" href="<?php echo base_url('data_siswa_guru/details/'.$terbaru->id_siswa) ?>">Detail</a>
                  </div>
                </div>
                <?php $count++; ?>
              <?php } ?>
