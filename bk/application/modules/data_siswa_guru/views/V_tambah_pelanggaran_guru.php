          ...
          <div class="panel panel-body">
            ...
            <div class="panel-body">
              ...
              <div class="col-sm-12">
                ...
                <p></p>
                <form action="<?php echo site_url('data_siswa_guru/caripelanggaran/'.$res->id_siswa) ?>" method="post" class="col-xs-8 col-sm-7 text-right">
                  <div class="input-group text-right"  style="padding-left: : 5px">
                    ...
                    <a class="btn btn-success form-control"  style="padding-left: : 10px" href="<?php echo base_url('data_siswa_guru/tampilpelanggaran/'.$res->id_siswa); ?>">
