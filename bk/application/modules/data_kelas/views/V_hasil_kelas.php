            ...
            <ul class="list-unstyled text-center bord-top pad-top mar-no row">
              <li class="col-xs-5">
                <span class="text-muted mar-no">
                  ...
                  $jumlah_pelanggaranku      = $this->m_data_kelas->count_jpelanggaran($id);
                  $jumlah_pelanggaran_kerapian  = $this->m_data_kelas->count_jpelanggaran_kerapian($id);
                  $jumlah_pelanggaran_berat   = $this->m_data_kelas->count_jpelanggaran_berat($id);
              ...
              <li class="col-xs-4">
                <span class="text-muted mar-no">
                  ...
                  $jumlah_treatment    = $this->m_data_kelas->count_jtreatment($id);
