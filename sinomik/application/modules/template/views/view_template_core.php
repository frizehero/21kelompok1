        ...
        <div class="boxed">
            ...
            <nav id="mainnav-container">
                ...
                <div id="mainnav-menu-wrap">
                    ...
                    <li class=" <?=$this->uri->segment('1') == 'data_pelanggaran' || $this->uri->segment(1) == 'data_treatment' || $this->uri->segment(1) == 'data_prestasi' ? "active-sub" : ''?>">
                        <a href="#">
                        ...
                        <ul class="collapse">
                            ...
                            <li class="<?php if ( $this->uri->segment(1) == 'data_prestasi' ) echo 'active-link'; ?>"><a href="<?php echo base_url('data_prestasi'); ?>">Data Prestasi</a></li>
                        </ul>
                    </li>
