...
<div id="page-head">
  ...
  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
  <div id="page-title">
    <h1 class="page-header text-overflow">pPestasi Siswa</h1>
  </div>
  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
  <!--End page title-->
  ...
  <ol class="breadcrumb">
    ...
    <li>Data Siswa</li>
    <li>Detail Siswa</li>
    <li class="active">pPrestasi Siswa</li>
  </ol>
  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
  <!--End breadcrumb-->
          ...
          <div class="panel panel-body">
            ...
            <div class="panel-body">
              ...
              <?php } else { ?>
                ...
                <td>Cari Prestasi </td>
                <p></p>
                <form action="<?php echo base_url('data_siswa_guru/cariprestasi/'.$id)?>" method="post" class="col-xs-8 col-sm-7 text-right">
                  <div class="input-group text-right"  style="padding-left: : 5px">
                    ...
                    <a class="btn btn-success form-control"  style="padding-left: : 10px" href="<?php echo base_url('data_siswa_guru/prestasi/'.$id); ?>">
                ...
                <?php if ($tampil == null) { ?>
                  <center>
                 <h2>Prestasi Tidak Ditemukan</h2></center>
              <?php } else { ?>
