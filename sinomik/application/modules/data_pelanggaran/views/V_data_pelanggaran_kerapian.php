  ...
  <div id="page-head">
    ...
    <div class="text-right breadcrumb">
     <div id="demo-custom-toolbar5" class="table-toolbar-left">
        ...
        <a href="<?php echo site_url('data_pelanggaran/download2/') ?>" class="btn btn-warning text-right "><span class="ion-archive"></span>Template Pelanggaran Kerapian</a>
      </div>
    <form action="<?php echo site_url('data_pelanggaran/cariku1/') ?>" method="post" class="col-xs-8 col-sm-3 text-right">
      <div class="input-group text-right"  style="padding-left: : 5px">
        ...
        <a class="btn btn-success form-control"  style="padding-left: : 10px" href="<?php echo base_url('data_pelanggaran/tampil1/'); ?>">
