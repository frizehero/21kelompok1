            ...
            <div id="mainnav">
                ...
                <div id="mainnav-menu-wrap">
                    ...
                    <li class=" <?=$this->uri->segment('1') == 'data_pelanggaran_guru' || $this->uri->segment(1) == 'data_treatment_guru' || $this->uri->segment(1) == 'data_prestasi_guru' ? "active-sub" : ''?>">
                        ...
                        <ul class="collapse">
                            <li class="<?php if ( $this->uri->segment(1) == 'data_pelanggaran_guru' ) echo 'active-link'; ?>"><a href="<?php echo base_url('data_pelanggaran_guru'); ?>">Data Pelanggaran</a></li>
                            ...
                            <li class="<?php if ( $this->uri->segment(1) == 'data_prestasi_guru' ) echo 'active-link'; ?>"><a href="<?php echo base_url('data_prestasi_guru'); ?>">Data Prestasi</a></li>
                        </ul>
                    </li>
