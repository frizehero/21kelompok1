  ...
  <div id="page-head">
    ...
    <div class="text-right breadcrumb">
      <div id="demo-custom-toolbar5" class="table-toolbar-left">
        <a class="btn btn-default text-left" type="button" href="<?php  echo base_url('data_laporan_guru/index/');  ?>">Kembali</a>
      </div>
      <form action="<?php echo site_url('data_laporan_guru/cariww/') ?>" method="post" class="col-xs-8 col-sm-3 text-right">
          ...
          <div class="widget-body">
            ...
            <div class="list-group bg-trans mar-no">
              ...
              <p class="pull-right">
               ...
               $jumlahpointprestasi    = $this->m_data_laporan_guru->jumlahpointprestasi($id);
