...
class M_siswa extends CI_Model {
	...
	function tampildetail($data_siswa)
	{
		$this->db->select('*')
		->from('data_siswa')
	...
	function tampilriwayat_treatment($data_siswa)
	{
		$this->db->select('*')
		...
		->where('riwayat_treatment.id_siswa',$data_siswa);
	...
	function count_jtreatment($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_treatment.id_siswa')
		->join('data_treatment','data_treatment.id_treatment = riwayat_treatment.id_treatment')
	...
	function tampilriwayat_pelanggaran($data_siswa)
	{
		$this->db->select('*')
		...
		->where('riwayat_pelanggaran.id_siswa',$data_siswa);
	...
	function count_jpelanggaran($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
		->join('data_pelanggaran','data_pelanggaran.id_pelanggaran = riwayat_pelanggaran.id_pelanggaran')
	...
	function count_jpelanggaran_kerapian($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
	...
	function count_jpelanggaran_berat($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
	...
	function tampilriwayat_pelanggaran_kerapian($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
		->join('data_pelanggaran_kerapian','data_pelanggaran_kerapian.id_pelanggaran_kerapian = riwayat_pelanggaran.id_pelanggaran_kerapian')
	...
	function tampilriwayat_pelanggaran_berat($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
		->join('data_pelanggaran_berat','data_pelanggaran_berat.id_pelanggaran_berat = riwayat_pelanggaran.id_pelanggaran_berat')
	...
	function tampilriwayat_pelanggaran_samping($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
		->join('data_pelanggaran','data_pelanggaran.id_pelanggaran = riwayat_pelanggaran.id_pelanggaran')
	...
	function tampilriwayat_pelanggaran_kerapian_samping($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
		->join('data_pelanggaran_kerapian','data_pelanggaran_kerapian.id_pelanggaran_kerapian = riwayat_pelanggaran.id_pelanggaran_kerapian')
	...
	function tampilriwayat_pelanggaran_berat_samping($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_pelanggaran.id_siswa')
		->join('data_pelanggaran_berat','data_pelanggaran_berat.id_pelanggaran_berat = riwayat_pelanggaran.id_pelanggaran_berat')
	...
	// {
	// 	$data_siswa_detail_siswa            = $this->input->post('id_siswa');
	...
	function jumlahpelanggaran1($data_siswa)
	{
	...
	function jumlahpelanggaran2($data_siswa)
	{
	...
	function jumlahpelanggaran3($data_siswa)
	{
	...
	function jumlahpointprestasi($data_siswa)
	{
	...
	function tampiltreatment($data_siswa)
	{
		$this->db->select('*')
		->from('data_siswa')
		->join('data_kelas','data_kelas.id_kelas = data_siswa.id_kelas')
	...
	function caritreatment($carit,$data_siswa)
	{
	...
	function tampilpelanggaran($data_siswa)
	{
		$this->db->select('*')
		->from('data_siswa')
		->join('data_kelas','data_kelas.id_kelas = data_siswa.id_kelas')
	...
	// model prestasi
	function tampilprestasi($data_siswa)
	{
		$this->db->select('*')
		->from('data_siswa')
		->join('data_kelas','data_kelas.id_kelas = data_siswa.id_kelas')
	...
	// function tambah_prestasi($data_siswa)
	// {
	...
	function tampilriwayat_prestasi($data_siswa)
	{
		$this->db->select('*')
		->join('data_siswa','data_siswa.id_siswa = riwayat_treatment.id_siswa')
