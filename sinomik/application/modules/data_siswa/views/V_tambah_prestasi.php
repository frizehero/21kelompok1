          ...
          <div class="panel panel-body">
            ...
            <div class="panel-body">
              ...
              <div class="col-sm-12">
                ...
                <td>Cari Prestasi </td>
                <p></p>
                <form action="<?php echo base_url('data_siswa/cariprestasi/'.$res->id_siswa)?>" method="post" class="col-xs-8 col-sm-7 text-right">
                  <div class="input-group text-right"  style="padding-left: : 5px">
                    ...
                    <a class="btn btn-success form-control"  style="padding-left: : 10px" href="<?php echo base_url('data_siswa/prestasi/'.$res->id_siswa); ?>">
                    ...
                    <div class="modal fade" id="demo-default-modal<?php echo $res->id_prestasi?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <?= form_open_multipart('data_siswa/tambah_prestasi/'.$res->id_siswa); ?>
