              ...
              <div class="col-sm-12">
               <?php if ($tampil == null) { ?>
                ...
                <div class="row">
                  ...
                  <td>Cari Prestasi </td>
                  <p></p>
                  <form action="<?php echo base_url('data_siswa/cariprestasi/'.$id)?>" method="post" class="col-xs-8 col-sm-7 text-right">
                    <div class="input-group text-right"  style="padding-left: : 5px">
                      ...
                      <a class="btn btn-success form-control"  style="padding-left: : 10px" href="<?php echo base_url('data_siswa/prestasi/'.$id); ?>">
